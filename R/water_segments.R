#' Modified version for by_s_m.R - for water segment calculation. This function outputs a data.frame rather than a list
#'
...
#'
#' @return data.frame(smz=smz,sms=sms)
...
#' C
#'
water_segments = function(thres=thres,z0=z0,zmax=zmax,z=z,sigma=sigma) {
